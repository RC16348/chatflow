        ...
        return parts.map((part, index) => {
            if (index % 2 === 1) {
                ...
                if (path) {
                    ...
                    return <img key={index} src={`${import.meta.env.BASE_URL}${emojiPath}`} alt={`[${part}]`} className="inline-emoji" style={{ width: 22, height: 22, verticalAlign: 'bottom', margin: '0 1px' }} />
                }
                return `[${part}]`
            }
            return part
