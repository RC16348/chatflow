...
import { MessageSquare, BarChart3, FileText, Settings, Download, Aperture, UserCircle, ChevronUp, RefreshCw, Bot } from 'lucide-react'
    ...
    <>
      <aside className={`sidebar ${collapsed ? 'collapsed' : ''}`}>
        <nav className="nav-menu">
          ...
          <NavLink
            to="/agent"
            className={`nav-item ${isActive('/agent') ? 'active' : ''}`}
